  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" rel="tooltip" title="Designed by Sidney Mphilo" data-placement="bottom" target="_blank">
        ...
        <div style="margin-top:180px !important; border-radius: none;">
            <div class="row" id="mainRow" style="margin: 5%; border-radius: 20px; padding: 10px; background-color: rgba(78, 78, 78, 0.432);">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link bg-light active text-dark" href="#">Active</a>
                    </li>
                  </ul>
                <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                              <div class="card" style="border-radius: 20px;">
                                <div class="card-body text-center">
                                  ...
                                  <a href="./test-page.php" class="btn btn-primary" style="border-radius: 20px;">START TEST</a>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="col-sm-6">
                    <div class="card-body text-light">
                        <h5 class="card-title">Big Five Personality Traits</h5>
                        <p class="card-text">Our system is designed to our users based on Big Five Personality Traits  </p>
                        <ol>
                            <li>Openness </li>
